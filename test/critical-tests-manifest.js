...
module.exports = [
  ...
  "edit-mechanism-behavioral.test.js",
  "edit-regeneration-forming-state-behavioral.test.js",
  "email-domain-check.test.js",
  "email-suppression-store.test.js",
  ...
  "first-dream-email-pending-store.test.js",
  "first-dream-email-resend-idempotency-key.test.js",
  "first-dream-email-store.test.js",
  "first-video-created-behavioral.test.js",
  "funnel-signup-navigation-token-guard-behavioral.test.js",
  "generate-avatar.test.js",
  ...
  "generation-completion-marker.test.js",
  "geo.test.js",
  "automatic-first-dream-email.test.js",
  ...
  "interp-audio-status.test.js",
  "interpret-dream.test.js",
  "job-owners.test.js",
  "journey-manifest.test.js",
  "life-origin-generate-handoff-behavioral.test.js",
  "like-dream.test.js",
  "logout-clears-pendingjob-behavioral.test.js",
  ...
  "send-first-dream-email.test.js",
  "send-pending-first-dream-emails.test.js",
  "server-analytics-containment.test.js",
  ...
  "shop-pricing-copy-sweep.test.js",
  ...
  "whisper-alignment-store.test.js",
