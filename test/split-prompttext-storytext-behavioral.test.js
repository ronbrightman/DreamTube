...
// ---------------------------------------------------------------------
// 5. RETIRED (unify-all-creation-flows, founder 2026-08-14): wizard.html’s
//    own SEPARATE chip-flow storyText computation was exercised end-to-end
//    here, but that chip-build creation flow is retired to a funnel-arrival
//    receiver (a bare wizard.html hit now redirects to /go/), so it is no
//    longer user-reachable. Its coverage lives on: the deterministic story +
//    LLM-upgrade assembly in test/wizard-chips.test.js; the same chips-only /
//    chips-with-free-text storyText behavior on the LIVE create.html Build
//    flow above (tests 1-3); and the funnel-arrival wall carrying the
//    assembled caption/storyText through start-pending-generation.js in
