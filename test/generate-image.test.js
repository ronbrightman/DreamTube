...
test('a brand-new email gets its 290-token signup grant materialized right here and proceeds', async function () {
  stubFetchOk();
  ...
  assert.equal(record.tokens.balance, 280, '290 granted, 10 spent on this successful generation');
});
