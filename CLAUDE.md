...
`research`, `evaluation`, `design`, and `review` are user-level agents
(`~/.claude/agents/`), portable across projects. `build` is
project-level (`.claude/agents/build.md`), since it needs to know this
specific codebase.
