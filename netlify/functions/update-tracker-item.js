...
// title/detail/category through this endpoint — that's seed-authored
// content (see tracker-store.js's SEED_ITEMS), not something the UI should
// let anyone accidentally mutate. If the founder wants to add new items
// later, that's a follow-up (a new endpoint or a seed edit), not something
// this endpoint grows into.
//
