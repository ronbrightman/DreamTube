...
// casting: voice `am_onyx`, speed `READING_SPEED` below (js/interpreter-
// personas.js's own `voiceId` field carries the voice id per persona;
// speed is fixed here, not yet a per-persona field — every persona reads
// at the same founder-approved pace this wave).
//
